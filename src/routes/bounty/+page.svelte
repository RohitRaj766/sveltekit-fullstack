...
>
  ...
  {#if form?.success}
    <p class="pt-2">Bounty was deployed successfully. <a href={form.tx} target="_blank" class="cursor-pointer text-blue-600 hover:underline">View Transaction</a></p>
  {/if}
</div>
